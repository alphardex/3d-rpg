...
export class SSGIDebugGUI {
  constructor(ssgiEffect, params = SSGIEffect.DefaultOptions) {
    ...
    generalFolder.addInput(params, "maxRoughness", {
      min: 0,
      max: 1,
      step: 0.01,
    });
    ...
    generalFolder.addInput(params, "maxEnvLuminance", {
      min: 0,
      max: 100,
      step: 1,
    });
    ...
    denoiseFolder.addInput(params, "denoiseIterations", {
      min: 0,
      max: 5,
      step: 1,
    });
    denoiseFolder.addInput(params, "denoiseKernel", {
      min: 1,
      max: 5,
      step: 1,
    });
